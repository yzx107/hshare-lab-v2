...
class SemanticTradeDirRunnerTests(unittest.TestCase):
    def test_runner_profiles_distinct_values(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            write_parquet(orders_dir / "orders.parquet", {"OrderId": [1], "OrderType": [1], "SeqNum": [1], "Time": ["093000"]})
            write_parquet(
