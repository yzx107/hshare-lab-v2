...
- `build_orderbook_top_of_book_only.py`：物化 `orderbook_replay__top_of_book_only`，只输出 best bid/ask、spread、mid、inside-book、`ReplayQualityScore` 与质量 gate，不输出 full depth
...
- `python -m Scripts.build_orderbook_top_of_book_only --print-plan`
